      ...
      <Box sx={{ display: 'flex', mb: 4 }}>
        <Container maxWidth='md'>
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
            ...
            <Typography variant='h5' sx={{ fontWeight: 'bold', fontFamily: 'Savoy Regular' }}>ABOUT THE GREENWOOD HOTEL</Typography>


            <Typography variant='body1' sx={{ mt: 2 }}>


              Standing as one of the most prominent luxury escapes in the town of Tezpur, the ‘Cultural Capital’ of Assam, The Greenwood, Tezpur entices anyone who wishes to absorb naturesque, vibrant and fun-filled moments, just close to the bustling urban landscape of the historic town.
              <br></br>
              Enjoying close proximity to renowned World Heritage Sites and nature reserves less than 50 kms, such as Kaziranga National Park and Nameri National Park, as well as some of the most spectacular cultural and historical hotspots in the state.
              <br></br>
              This property is a quintessential replica of a retreat surrounded by beautiful hills, deep valleys and lush greenery adding an ancient touch to take you back to an era you would have only read about, you need to visit Tezpur in Assam.
            ...
            <Box sx={{ display: "flex", alignItems: "center", flexDirection: 'row', mt: 12 }}>
              ...
              <Typography variant="h7" style={{ fontFamily: 'Savoy Regular', textTransform: 'uppercase' }}>
                THE CONTEMPORARY AMBIENCE
              </Typography>
            </Box>
            <Box sx={{ display: "flex", mt: 2, alignItems: "center", justifyContent: "center", flexDirection: 'row' }} >
              <Typography variant="body1" sx={{ fontFamily: 'Savoy Italic', width: '90%', align: "center", textAlign: "center" }}>
